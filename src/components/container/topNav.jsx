        ...
        <div className="space-x-4 flex items-center">
          ...
          <div className="flex items-center space-x-2">
            <div className="flex flex-col">
              <div className="font-medium text-[#132D46] w-full text-ellipsis whitespace-nowrap overflow-hidden">
                Officer Jim Iyke
              </div>
              <div className="hidden sm:flex justify-end text-gray-500 w-full text-ellipsis whitespace-nowrap overflow-hidden">
                Brian johnson
              </div>
            </div>
