...
function Index() {
  ...
  return (
    <Container>
      ...
      {isEmpty && <div className="w-full h-full px-4 py-4 space-y-8">
      <button
      ...
      {!isEmpty && <div className="hidden sm:block px-4 sm:px-4 py-4 border-r space-y-3 bg-white border-gray-400 shadow-sm w-[240px] sm:w-[310px] ">
       <button
          onClick={() => setIsFilter(!isFilter)}
          className="rounded-md flex space-x-8 items-center p-2 bg-secondary-100 text-white"
        >
     ...
     {!isEmpty && <div className=" w-full h-full">
