  ...
  const navigate = useNavigate()
    return (
        <div className="absolute top-[55px] ">
            ...
            <div
            className="relative cursor-pointer text-[#132D46] flex flex-col z-[300]  items-center bg-white shadow-lg w-[200px] h-fit p-3 rounded-lg">
            <div className="w-full items-center flex justify-center flex-col mb-4 space-y-1">
                  ...
                  <div className="text-[13px] sm:text-sm font-semibold text-[#132D46]">Jane Doe</div>
                  <div className="text-[13px] sm:text-sm text-gray-500">Jane@gmail.com</div>
                ...
                <AiOutlineGlobal className="text-[16px] text-[#01C38D]" />
