...
const PersonalCamera = () => {
  ...
  return (
    <ClientContainer>
      <div className="w-full text-[#132D46] 0 h-fit py-[4rem] space-y-4 sm:space-y-5 sm:py-[73px]">
        ...
        <div
          className={`px-2 sm:px-6 gap-6 grid grid-cols-1 sm:grid-cols-2  resize === 1 ? "md:grid-cols-1" : ""
